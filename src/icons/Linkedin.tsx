export default function Linkedin() {
  return (
    <svg className="w-6 h-6 text-pink-400 transition-all hover:text-pink-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 15 15">
